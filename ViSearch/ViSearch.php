...
class ViSearch extends ViSearchBaseRequest
{
    ...
    */
     ...
     * @get_all_fl, If the value is true, All field list will be returned in the query
     */
    function uploadsearch($image=NULL, $page=1, $limit=30, $fl=array(), $fq=array(), $get_all_fl=false, $score=false, $score_max=1, $score_min=0, $detection=''){
     ...
     * @get_all_fl, If the value is true, All field list will be returned in the query
     */
    function discoversearch($image=NULL, $page=1, $limit=30, $fl=array(), $fq=array(), $get_all_fl=false, $score=false, $score_max=1, $score_min=0, $detection=''){
       if (!gettype($image) == 'object' || !get_class($image) == 'Image')
        throw new ViSearchException('Need to pass a image object');
